...
//		CURSED_COPPER_CREEPER_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "cursed_copper_creeper_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, StructuresIncludeCoinsFeature.COPPER_LOOT_TABLES, MobsDropCoinsFeature.COPPER_MOB_DROPS  );
		CURSED_COPPER_IRON_GOLEM_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "cursed_copper_iron_golem_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.VILLAGE_ARMORER_CHEST,LootTables.PILLAGER_OUTPOST_CHEST), Set.of(EntityType.IRON_GOLEM), List.of(StewEffects.SLOWNESS) );
		CURSED_COPPER_ZOMBIE_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "cursed_copper_zombie_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.ANCIENT_CITY_CHEST), Set.of(EntityType.ZOMBIE), List.of(StewEffects.HUNGER) );
		...
		CURSED_IRON_VEX_COIN = InventoryEffectCoinFeature.registerCraftableInventoryEffectCoinItem( Villagercoin.MOD_ID, "cursed_iron_vex_coin", CollectableCoinFeature.IRON_VALUE, CoinFeature.IRON_RARITY, CollectableCoinFeature.IRON_DROP_CHANCE, 1, 1, 1, CoinFeature.IRON_FLIP_CHANCE, CollectableCoinFeature.IRON_MAXIMUM_IN_CIRCULATION, Set.of(LootTables.WOODLAND_MANSION_CHEST), Set.of(EntityType.VEX), List.of(StewEffects.BAD_OMEN,StewEffects.LEVITATION) );
